<!-- app/Views/contactus.php --> <?= $this->extend('layout/pageslayout') ?> <?= $this->section('content') ?>
<!-------Contact Start------->
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-8">
                            <form id="contact_form" action="">
                                ...
                                <input class="btn-grad w-100 text-uppercase" type="submit" value="Submit">
                            </form>
                        </div>
