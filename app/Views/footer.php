...
<footer class="footer-copy">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <p> 2024 &copy; Applight. Website Designed by <a href="http://w3Template.com" target="_blank"
                        rel="dofollow">W3 Template</a>
                </p>
            </div>
        </div>
    </div>
...
$(window).on("scroll", function() {
    var bodyScroll = $(window).scrollTop(),
        navbar = $(".navbar");
    if (bodyScroll > 50) {
        $(".navbar-logo img").attr("src", "assets/images/logo-black.png");
        navbar.addClass("nav-scroll");
    } else {
        $(".navbar-logo img").attr("src", "assets/images/logo.png");
...
$(window).on("load", function() {
    ...
    if (bodyScroll > 50) {
        ...
        $(".navbar-logo img").attr("src", "assets/images/logo-white.png");
        navbar.removeClass("nav-scroll");
    }
    $.scrollIt({
